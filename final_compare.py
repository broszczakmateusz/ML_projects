...
def algorithm_stats(algorithm_name, y_validate, predicted_classes):
    ...
    M = confusion_matrix(target=y_validate, predicted=predicted_classes, n=3, index_dict= {0: 0, 1: 1, 2: 2})
...
def main():
    ...
    algorithm_stats("1-vs-rest", y_validate, predicted_classes)
